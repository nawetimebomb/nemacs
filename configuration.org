...
Treat headers (.h) as C++ files.

#+BEGIN_SRC emacs-lisp
(add-to-list 'auto-mode-alist '("\\.h\\'" . c++-mode))
#+END_SRC

Indentation and code styling configuration.

#+BEGIN_SRC emacs-lisp
(defun elnawe::c++-mode-hook ()
  (c-set-style "stroustrup")
  (auto-fill-mode)
  (c-set-offset 'substatement-open 0)
  (c-toggle-auto-hungry-state 0))

(add-hook 'c++-mode-hook 'elnawe::c++-mode-hook)
#+END_SRC

Code completition

#+BEGIN_SRC emacs-lisp
;; Need to confirm that clang and cMake are installed before making this a default configuration.
...
Configuring Emacs to use Racer when programming Rust
...
The original Rust language theme inspired from
[[https://doc.rust-lang.org/book/second-edition][The Rust Programming
Language]] book.
