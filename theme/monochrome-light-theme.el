(deftheme monochrome-light
  "A white background, gray-scale and black theme.")

(let
    ((background           "#ffffff")
     (standard-text        "#242424")
     (very-high-contrast   "#303030")
     (high-contrast        "#616161")
     (medium-contrast      "#7f7f7f")
     (low-contrast         "#a9a9a9")
     (very-low-contrast    "#c5c5c5")
     (windows-blue         "#094ab2")
     (bloody-red           "#ff4c4c")
     (zenburn-green        "#5f7f5f"))
  ...
  (custom-theme-set-faces
   ...
   `(region ((t (:background ,windows-blue :foreground ,background))))
   ...
   `(font-lock-comment-face ((t (:foreground ,low-contrast :slant italic))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,low-contrast :slant italic))))
   `(font-lock-warning-face ((t (:foreground ,low-contrast :slant italic :weight bold))))
   `(font-lock-doc-face ((t (:foreground ,low-contrast :slant italic))))

   `(font-lock-function-name-face ((t (:inherit (default)))))
   `(font-lock-variable-name-face ((t (:inherit (default)))))

   `(font-lock-type-face ((t (:foreground ,low-contrast))))
   `(font-lock-string-face ((t (:foreground ,low-contrast))))
   ...
   `(js2-jsdoc-tag ((t (:foreground ,low-contrast :slant italic :weight bold))))
   `(typescript-jsdoc-tag ((t (:foreground ,low-contrast :slant italic :weight bold))))
   `(js2-jsdoc-value ((t (:foreground ,low-contrast :slant italic :weight normal))))
   `(typescript-jsdoc-tag ((t (:foreground ,low-contrast :slant italic :weight bold))))
   ...
   ;; Org
   `(org-date ((t (:foreground ,low-contrast))))
   ...
   `(spaceline-modified ((t (:background ,bloody-red :foreground ,very-low-contrast :inherit (mode-line) :weight bold))))
   `(spaceline-unmodified ((t (:foreground ,very-low-contrast :inherit (mode-line) :weight bold))))
   `(spaceline-read-only ((t (:background ,windows-blue :foreground ,very-low-contrast :inherit (mode-line) :weight bold))))
