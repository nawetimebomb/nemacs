...
(custom-theme-set-faces
 ...
 '(error ((t (:foreground "#aa3030" :underline nil :weight bold))))
 ...
 '(minibuffer-prompt ((t (:foreground "#54ff9f" :weight normal))))
 '(highlight ((t (:background "#656565"))))
 ...
 '(mode-line ((t (:background "#0087af" :foreground "black" :box nil))))
 ...
 '(isearch-fail ((t (:background "#aa3030" :foreground "grey94" :weight bold))))
 ...
 '(org-level-3 ((t (:foreground "#0087af"))))
 '(org-level-4 ((t (:foreground "#a0a0a0"))))
 '(org-hide ((t (:inherit (default) :inverse-video t))))
 '(org-warning ((t (:inherit (error)))))

 '(js2-error ((t (:foreground "#aa3030"))))
