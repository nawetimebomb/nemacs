(deftheme monochrome-dark
  "A greyscale theme, forked from Tao Theme")
...
(let ((color-1    "#050505")
  ...
  (custom-theme-set-faces
   ...
   ;; anzu
   `(anzu-replace-to                                  ((t (:foreground ,color-8 :slant italic :underline t))))
   ;; isearch
   `(isearch                                          ((t (:foreground ,color-11 :background ,color-6 :weight bold))))
   `(isearch-fail                                     ((t (:foreground ,color-13 :background ,color-7))))
   `(lazy-highlight                                   ((t (:foreground ,color-11 :background ,color-5 :underline t :weight bold))))
   `(menu                                             ((t (:foreground ,color-13 :background ,color-4))))
   `(minibuffer-prompt                                ((t (:foreground ,color-1 :background ,color-9 ))))
   `(mode-line                                        ((t (:foreground ,color-12 :background ,color-1 :box nil))))
   `(mode-line-highlight                              ((t (:box nil :underline t :weight bold))))
   `(mode-line-inactive                               ((t (:foreground ,color-9 :background ,color-6 :box nil))))
   `(mode-line-buffer-id                              ((t (:foreground ,color-14 :weight bold))))
   `(region                                           ((t (:background ,color-9 :foreground ,color-3))))
   ...
   `(spaceline-modified                               ((t (:background ,color-15 :foreground ,color-1 :weight bold))))
   ...
   `(newsticker-extra-face                            ((t (:foreground ,color-7))))
   ...
   ;; diff
   `(diff-added                                       ((t (:foreground ,color-13 :background nil))))
   `(diff-changed                                     ((t (:foreground ,color-13))))
   `(diff-removed                                     ((t (:foreground ,color-10 :background nil))))
   `(diff-refine-added                                ((t :inherit diff-added :weight bold)))
   `(diff-refine-change                               ((t :inherit diff-changed :weight bold)))
   `(diff-refine-removed                              ((t :inherit diff-removed :weight bold)))
   `(diff-header                                      ((t (:background ,color-7))))
   `(diff-file-header                                 ((t (:background ,color-7 :foreground ,color-13 :bold t))))
   ;; dired
   ...
   ;; flycheck
   `(flycheck-error                                   ((t (:foreground ,color-7 :weight bold :underline t))))
   `(flycheck-warning                                 ((t (:foreground ,color-9 :weight bold :underline t))))
   `(flycheck-info                                    ((t (:foreground ,color-10 :weight bold :underline t))))
   `(flycheck-fringe-error                            ((t (:inherit error))))
   `(flycheck-fringe-warning                          ((t (:inherit fringe))))
   `(flycheck-fringe-info                             ((t (:inherit fringe))))
   ;; flyspell
   `(flyspell-duplicate                               ((t (:foreground ,color-11 :underline (:style wave)))))
   `(flyspell-incorrect                               ((t (:foreground ,color-9 :underline (:style wave)))))
   ;; erc
   ...
   `(helm-swoop-target-word-face                      ((t (:foreground ,color-13 :background ,color-8))))
   `(helm-swoop-target-line-face                      ((t ( :foreground ,color-12 :background ,color-6))))
   `(helm-swoop-target-line-block-face                ((t ( :foreground ,color-2 :background ,color-7))))
   ;; hl-line-mode
   `(hl-line-face                                     ((t (:background ,color-3)) (t :weight bold)))
   `(hl-line                                          ((t (:background ,color-3)) (t :weight bold)))
   ;; hl-sexp
   `(hl-sexp-face                                     ((t (:background ,color-6)) (t :weight bold)))
   ;; ido-mode
   ...
   ;; js2-mode
   `(js2-warning                                      ((t (:underline ,color-10))))
   ...
   `(js2-function-call                                ((t (:foreground, color-12 :slant italic))))
   `(js2-object-property                              ((t (:foreground, color-12))))
   `(js2-external-variable                            ((t (:foreground ,color-10 :italic nil))))
   ...
   `(mu4e-header-highlight-face                       ((t (:bold t :background ,color-8 :foreground ,color-4))))
   `(mu4e-highlight-face                              ((t (:bold t))))
   `(mu4e-replied-face                                ((t (:foreground ,color-8))))
   `(mu4e-title-face                                  ((t (:foreground ,color-14 :bold t :underline nil))))
   ...
   ;; org-mode
   `(org-agenda-date-today                            ((t (:foreground ,color-14 :slant italic :weight bold))))
   `(org-agenda-done                                  ((t (:foreground ,color-13 :strike-through t))))
   `(org-agenda-clocking                              ((t (:foreground ,color-14 :weight bold))) t)
   `(org-agenda-structure                             ((t (:inherit font-lock-comment-face))))
   `(org-archived                                     ((t (:foreground ,color-13 :weight bold))))
   `(org-checkbox                                     ((t (:foreground ,color-14 :box (:line-width 1 :style released-button)))))
   ...
   `(org-level-5                                      ((t (:foreground ,color-14 :bold t))))
   `(org-level-6                                      ((t (:foreground ,color-14 :bold t))))
   `(org-level-7                                      ((t (:foreground ,color-14 :bold t))))
   `(org-level-8                                      ((t (:foreground ,color-14 :bold t))))
   ...
   `(org-done                                         ((t (:bold t :background ,color-5 :foreground ,color-13 :weight bold))))
   `(org-todo                                         ((t (:bold t :foreground ,color-8 :underline t :weight bold))))
   ...
   `(org-checkbox-statistics-todo                     ((t (:foreground ,color-2 :background ,color-12 :bold t))))
   `(org-ellipsis                                     ((t (:foreground ,color-8 ))))
   `(org-footnote                                     ((t (:foreground ,color-12 ))))
   `(org-meta-line                                    ((t (:foreground ,color-8))))
   `(org-special-keyword                              ((t (:inherit org-meta-line))))
   `(org-property-value                               ((t (:foreground ,color-9))))
   `(org-block-background                             ((t (:background ,color-4 :foreground ,color-7))))
   `(org-block                                        ((t (:background ,color-4 :foreground ,color-7))))
   ;; outline
   ...
   `(markdown-header-face-3                           ((t (:inherit markdown-header-face :underline t))))
   `(markdown-header-face-4                           ((t (:inherit markdown-header-face :underline t))))
   ...
   `(markdown-pre-face                                ((t (:foreground ,color-13))))
   ...
   ;; all-the-icons
   `(all-the-icons-blue                               ((t (:foreground ,color-12))))
   `(all-the-icons-blue-alt                           ((t (:foreground ,color-10))))
   `(all-the-icons-cyan                               ((t (:foreground ,color-12))))
   `(all-the-icons-cyan-alt                           ((t (:foreground ,color-10))))
   `(all-the-icons-dblue                              ((t (:foreground ,color-8))))
   `(all-the-icons-dcyan                              ((t (:foreground ,color-8))))
   `(all-the-icons-dgreen                             ((t (:foreground ,color-8))))
   `(all-the-icons-dmaroon                            ((t (:foreground ,color-8))))
   `(all-the-icons-dorange                            ((t (:foreground ,color-8))))
   `(all-the-icons-dpink                              ((t (:foreground ,color-8))))
   `(all-the-icons-dpurple                            ((t (:foreground ,color-8))))
   `(all-the-icons-dred                               ((t (:foreground ,color-8))))
   `(all-the-icons-dsilver                            ((t (:foreground ,color-8))))
   `(all-the-icons-dyellow                            ((t (:foreground ,color-12))))
   `(all-the-icons-green                              ((t (:foreground ,color-8))))
   `(all-the-icons-lblue                              ((t (:foreground ,color-14))))
   `(all-the-icons-lcyan                              ((t (:foreground ,color-14))))
   `(all-the-icons-lgreen                             ((t (:foreground ,color-14))))
   `(all-the-icons-lmaroon                            ((t (:foreground ,color-14))))
   `(all-the-icons-lorange                            ((t (:foreground ,color-14))))
   `(all-the-icons-lpink                              ((t (:foreground ,color-14))))
   `(all-the-icons-lpurple                            ((t (:foreground ,color-14))))
   `(all-the-icons-lred                               ((t (:foreground ,color-14))))
   `(all-the-icons-lsilver                            ((t (:foreground ,color-14))))
   `(all-the-icons-lyellow                            ((t (:foreground ,color-14))))
   `(all-the-icons-maroon                             ((t (:foreground ,color-12))))
   `(all-the-icons-orange                             ((t (:foreground ,color-12))))
   `(all-the-icons-pink                               ((t (:foreground ,color-12))))
   `(all-the-icons-purple                             ((t (:foreground ,color-12))))
   `(all-the-icons-red                                ((t (:foreground ,color-12))))
   `(all-the-icons-red-alt                            ((t (:foreground ,color-10))))
   `(all-the-icons-silver                             ((t (:foreground ,color-12))))
   `(all-the-icons-yellow                             ((t (:foreground ,color-12))))
   ;; avy
