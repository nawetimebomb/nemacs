...
;;;;; grep
   ...
   `(match ((t (:background ,zenburn-bg-2 :foreground ,zenburn-orange :weight bold))))
;;;;; hi-lock
   `(hi-blue    ((t (:background ,zenburn-cyan    :foreground ,zenburn-bg-2))))
   `(hi-green   ((t (:background ,zenburn-green+4 :foreground ,zenburn-bg-2))))
   `(hi-pink    ((t (:background ,zenburn-magenta :foreground ,zenburn-bg-2))))
   `(hi-yellow  ((t (:background ,zenburn-yellow  :foreground ,zenburn-bg-2))))
...
;;;;; isearch
   ...
   `(menu ((t (:foreground ,zenburn-fg :background ,zenburn-bg-1))))
...
;;;;; newsticker
   ...
   `(newsticker-treeview-selection-face ((t (:background ,zenburn-bg-2 :foreground ,zenburn-yellow))))
;;;;; woman
...
;;;;; ace-jump
   ...
   `(ace-jump-face-foreground
     ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1 :inverse-video nil))))
;;;;; ace-window
   `(aw-background-face
     ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg-1 :inverse-video nil))))
...
;;;;; anzu
   ...
   `(anzu-match-1 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-green))))
   `(anzu-match-2 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-orange))))
   `(anzu-match-3 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-blue))))
...
;;;;; agda-mode
   ...
   `(agda2-highlight-error-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-magenta))))
   `(agda2-highlight-unsolved-meta-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-magenta))))
   `(agda2-highlight-unsolved-constraint-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-magenta))))
   `(agda2-highlight-termination-problem-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-magenta))))
   `(agda2-highlight-incomplete-pattern-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-magenta))))
...
;;;;; auto-complete
   ...
   `(popup-isearch-match ((t (:background ,zenburn-bg-1 :foreground ,zenburn-fg))))
;;;;; avy
   `(avy-background-face
     ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg-1 :inverse-video nil))))
   `(avy-lead-face-0
     ((t (:foreground ,zenburn-green+3 :background ,zenburn-bg-1 :inverse-video nil :weight bold))))
   `(avy-lead-face-1
     ((t (:foreground ,zenburn-yellow :background ,zenburn-bg-1 :inverse-video nil :weight bold))))
   `(avy-lead-face-2
     ((t (:foreground ,zenburn-red+1 :background ,zenburn-bg-1 :inverse-video nil :weight bold))))
   `(avy-lead-face
     ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-1 :inverse-video nil :weight bold))))
;;;;; company-mode
   ...
   `(company-tooltip-annotation-selection ((t (:foreground ,zenburn-orange :background ,zenburn-bg-2))))
   `(company-tooltip-selection ((t (:foreground ,zenburn-fg :background ,zenburn-bg-2))))
   `(company-tooltip-mouse ((t (:background ,zenburn-bg-2))))
   `(company-tooltip-common ((t (:foreground ,zenburn-green+2))))
   `(company-tooltip-common-selection ((t (:foreground ,zenburn-green+2))))
   `(company-scrollbar-fg ((t (:background ,zenburn-bg-2))))
   `(company-scrollbar-bg ((t (:background ,zenburn-bg+2))))
   `(company-preview ((t (:background ,zenburn-green+2))))
   `(company-preview-common ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-2))))
;;;;; bm
   `(bm-face ((t (:background ,zenburn-yellow-1 :foreground ,zenburn-bg-1))))
   `(bm-fringe-face ((t (:background ,zenburn-yellow-1 :foreground ,zenburn-bg-1))))
   `(bm-fringe-persistent-face ((t (:background ,zenburn-green-2 :foreground ,zenburn-bg-1))))
   `(bm-persistent-face ((t (:background ,zenburn-green-2 :foreground ,zenburn-bg-1))))
;;;;; calfw
...
;;;;; circe
   ...
   `(circe-prompt-face ((t (:foreground ,zenburn-orange :background ,zenburn-bg-1 :weight bold))))
;;;;; context-coloring
...
;;;;; ctable
   `(ctbl:face-cell-select ((t (:background ,zenburn-blue :foreground ,zenburn-bg-1))))
   `(ctbl:face-continue-bar ((t (:background ,zenburn-bg-05 :foreground ,zenburn-bg-1))))
   `(ctbl:face-row-select ((t (:background ,zenburn-cyan :foreground ,zenburn-bg-1))))
;;;;; debbugs
...
;;;;; diff
   ...
   `(diff-file-header
     ((,class (:background ,zenburn-bg+2 :foreground ,zenburn-fg :weight bold))
      (t (:background ,zenburn-fg :foreground ,zenburn-bg-1 :weight bold))))
;;;;; diff-hl
...
;;;;; dired+
   ...
   `(diredp-dir-heading ((t (:foreground ,zenburn-blue :background ,zenburn-bg-2))))
...
;;;;; diredfl
   ...
   `(diredfl-dir-heading ((t (:foreground ,zenburn-blue :background ,zenburn-bg-2))))
...
;;;;; emacs-w3m
   ...
   `(w3m-lnum ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1))))
   `(w3m-lnum-match ((t (:background ,zenburn-bg-2
...
;;;;; erc
   ...
   `(erc-prompt-face ((t (:foreground ,zenburn-orange :background ,zenburn-bg-1 :weight bold))))
   `(erc-timestamp-face ((t (:foreground ,zenburn-green+4))))
   `(erc-underline-face ((t (:underline t))))
;;;;; eros
   `(eros-result-overlay-face ((t (:background unspecified))))
;;;;; ert
   `(ert-test-result-expected ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg-1))))
   `(ert-test-result-unexpected ((t (:foreground ,zenburn-red :background ,zenburn-bg-1))))
;;;;; eshell
...
;;;;; full-ack
   ...
   `(ack-match ((t (:foreground ,zenburn-orange :background ,zenburn-bg-2 :weight bold))))
;;;;; git-annex
...
;;;;; gnus
   ...
   `(gnus-x ((t (:background ,zenburn-fg :foreground ,zenburn-bg-1))))
   `(mm-uu-extract ((t (:background ,zenburn-bg-05 :foreground ,zenburn-green+1))))
;;;;; go-guru
   `(go-guru-hl-identifier-face ((t (:foreground ,zenburn-bg-2 :background ,zenburn-green+1))))
;;;;; guide-key
...
;;;;; helm
   ...
   `(helm-visible-mark ((t (:foreground ,zenburn-bg-1 :background ,zenburn-yellow-2))))
   `(helm-candidate-number ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg-1))))
   `(helm-separator ((t (:foreground ,zenburn-red :background ,zenburn-bg-1))))
   `(helm-time-zone-current ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1))))
   `(helm-time-zone-home ((t (:foreground ,zenburn-red :background ,zenburn-bg-1))))
   `(helm-bookmark-addressbook ((t (:foreground ,zenburn-orange :background ,zenburn-bg-1))))
   `(helm-bookmark-directory ((t (:foreground nil :background nil :inherit helm-ff-directory))))
   `(helm-bookmark-file ((t (:foreground nil :background nil :inherit helm-ff-file))))
   `(helm-bookmark-gnus ((t (:foreground ,zenburn-magenta :background ,zenburn-bg-1))))
   `(helm-bookmark-info ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1))))
   `(helm-bookmark-man ((t (:foreground ,zenburn-yellow :background ,zenburn-bg-1))))
   `(helm-bookmark-w3m ((t (:foreground ,zenburn-magenta :background ,zenburn-bg-1))))
   `(helm-buffer-not-saved ((t (:foreground ,zenburn-red :background ,zenburn-bg-1))))
   `(helm-buffer-process ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-1))))
   `(helm-buffer-saved-out ((t (:foreground ,zenburn-fg :background ,zenburn-bg-1))))
   `(helm-buffer-size ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg-1))))
   `(helm-ff-directory ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-1 :weight bold))))
   `(helm-ff-file ((t (:foreground ,zenburn-fg :background ,zenburn-bg-1 :weight normal))))
   `(helm-ff-executable ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1 :weight normal))))
   `(helm-ff-invalid-symlink ((t (:foreground ,zenburn-red :background ,zenburn-bg-1 :weight bold))))
   `(helm-ff-symlink ((t (:foreground ,zenburn-yellow :background ,zenburn-bg-1 :weight bold))))
   `(helm-ff-prefix ((t (:foreground ,zenburn-bg-1 :background ,zenburn-yellow :weight normal))))
   `(helm-grep-cmd-line ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-1))))
   `(helm-grep-file ((t (:foreground ,zenburn-fg :background ,zenburn-bg-1))))
   `(helm-grep-finish ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1))))
   `(helm-grep-lineno ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg-1))))
   `(helm-grep-match ((t (:foreground nil :background nil :inherit helm-match))))
   `(helm-grep-running ((t (:foreground ,zenburn-red :background ,zenburn-bg-1))))
   `(helm-match ((t (:foreground ,zenburn-orange :background ,zenburn-bg-1 :weight bold))))
   `(helm-moccur-buffer ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-1))))
   `(helm-mu-contacts-address-face ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg-1))))
   `(helm-mu-contacts-name-face ((t (:foreground ,zenburn-fg :background ,zenburn-bg-1))))
;;;;; helm-swoop
...
;;;;; hl-sexp
   `(hl-sexp-face ((,class (:background ,zenburn-bg+1))
                   (t :weight bold)))
;;;;; hydra
   `(hydra-face-red ((t (:foreground ,zenburn-red-1 :background ,zenburn-bg-1))))
   `(hydra-face-amaranth ((t (:foreground ,zenburn-red-3 :background ,zenburn-bg-1))))
   `(hydra-face-blue ((t (:foreground ,zenburn-blue :background ,zenburn-bg-1))))
   `(hydra-face-pink ((t (:foreground ,zenburn-magenta :background ,zenburn-bg-1))))
   `(hydra-face-teal ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-1))))
;;;;; info+
   `(info-command-ref-item ((t (:background ,zenburn-bg-2 :foreground ,zenburn-orange))))
   `(info-constant-ref-item ((t (:background ,zenburn-bg-2 :foreground ,zenburn-magenta))))
   `(info-double-quoted-name ((t (:inherit font-lock-comment-face))))
   `(info-file ((t (:background ,zenburn-bg-2 :foreground ,zenburn-yellow))))
   `(info-function-ref-item ((t (:background ,zenburn-bg-2 :inherit font-lock-function-name-face))))
   `(info-macro-ref-item ((t (:background ,zenburn-bg-2 :foreground ,zenburn-yellow))))
   `(info-menu ((t (:foreground ,zenburn-yellow))))
   `(info-quoted-name ((t (:inherit font-lock-constant-face))))
   `(info-reference-item ((t (:background ,zenburn-bg-2))))
   `(info-single-quote ((t (:inherit font-lock-keyword-face))))
   `(info-special-form-ref-item ((t (:background ,zenburn-bg-2 :foreground ,zenburn-yellow))))
   `(info-string ((t (:inherit font-lock-string-face))))
   `(info-syntax-class-item ((t (:background ,zenburn-bg-2 :foreground ,zenburn-blue+1))))
   `(info-user-option-ref-item ((t (:background ,zenburn-bg-2 :foreground ,zenburn-red))))
   `(info-variable-ref-item ((t (:background ,zenburn-bg-2 :foreground ,zenburn-orange))))
;;;;; irfc
...
;;;;; ivy
   ...
   `(ivy-cursor ((t (:foreground ,zenburn-bg-1 :background ,zenburn-fg))))
   `(ivy-match-required-face ((t (:foreground ,zenburn-red :background ,zenburn-bg-1))))
   ...
   `(ivy-remote ((t (:foreground ,zenburn-blue :background ,zenburn-bg-1))))
   `(ivy-subdir ((t (:foreground ,zenburn-yellow :background ,zenburn-bg-1))))
;;;;; ido-mode
...
;;;;; lispy
   ...
   `(lispy-cursor-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-fg))))
...
;;;;; ruler-mode
   ...
   `(ruler-mode-default ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1))))

;;;;; lui
   `(lui-time-stamp-face ((t (:foreground ,zenburn-blue-1))))
   `(lui-hilight-face ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-1))))
   `(lui-button-face ((t (:inherit hover-highlight))))
;;;;; macrostep
   `(macrostep-gensym-1
     ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg-2))))
   `(macrostep-gensym-2
     ((t (:foreground ,zenburn-red+1 :background ,zenburn-bg-2))))
   `(macrostep-gensym-3
     ((t (:foreground ,zenburn-blue+1 :background ,zenburn-bg-2))))
   `(macrostep-gensym-4
     ((t (:foreground ,zenburn-magenta :background ,zenburn-bg-2))))
   `(macrostep-gensym-5
...
;;;;;; blame
   `(magit-blame-heading ((t (:background ,zenburn-bg-2 :foreground ,zenburn-blue-2))))
   `(magit-blame-hash    ((t (:background ,zenburn-bg-2 :foreground ,zenburn-blue-2))))
   `(magit-blame-name    ((t (:background ,zenburn-bg-2 :foreground ,zenburn-orange))))
   `(magit-blame-date    ((t (:background ,zenburn-bg-2 :foreground ,zenburn-orange))))
   `(magit-blame-summary ((t (:background ,zenburn-bg-2 :foreground ,zenburn-blue-2
                                          :weight bold))))
;;;;;; references etc
...
;;;;; mic-paren
   `(paren-face-match ((t (:foreground ,zenburn-cyan :background ,zenburn-bg-1 :weight bold))))
   `(paren-face-mismatch ((t (:foreground ,zenburn-bg-1 :background ,zenburn-magenta :weight bold))))
   `(paren-face-no-match ((t (:foreground ,zenburn-bg-1 :background ,zenburn-red :weight bold))))
;;;;; mingus
...
;;;;; mumamo
   ...
   `(mumamo-background-chunk-submode1 ((t (:background ,zenburn-bg-2))))
...
;;;;; org-mode
   ...
   `(org-column ((t (:background ,zenburn-bg-2))))
   `(org-column-title ((t (:background ,zenburn-bg-2 :underline t :weight bold))))
   `(org-mode-line-clock ((t (:foreground ,zenburn-fg :background ,zenburn-bg-2))))
   `(org-mode-line-clock-overrun ((t (:foreground ,zenburn-bg-1 :background ,zenburn-red-1))))
   ...
   `(org-habit-alert-face ((t :background ,zenburn-yellow-1 :foreground ,zenburn-bg-1)))
   ...
   `(org-habit-alert-future-face ((t :background ,zenburn-yellow-2 :foreground ,zenburn-bg-1)))
...
;;;;; c/perl
   ...
   `(cperl-array-face ((t (:foreground ,zenburn-yellow, :backgorund ,zenburn-bg-1))))
   `(cperl-hash-face ((t (:foreground ,zenburn-yellow-1, :background ,zenburn-bg-1))))
;;;;; perspective
...
;;;;; proofgeneral
   ...
   `(proof-eager-annotation-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-orange))))
   `(proof-error-face ((t (:foreground ,zenburn-fg :background ,zenburn-red-4))))
   `(proof-highlight-dependency-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-yellow-1))))
   `(proof-highlight-dependent-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-orange))))
   `(proof-locked-face ((t (:background ,zenburn-blue-5))))
   `(proof-mouse-highlight-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-orange))))
   `(proof-queue-face ((t (:background ,zenburn-red-4))))
   `(proof-region-mouse-highlight-face ((t (:inherit proof-mouse-highlight-face))))
   `(proof-script-highlight-error-face ((t (:background ,zenburn-red-2))))
   `(proof-tacticals-name-face ((t (:inherit font-lock-constant-face :foreground nil :background ,zenburn-bg-1))))
   `(proof-tactics-name-face ((t (:inherit font-lock-constant-face :foreground nil :background ,zenburn-bg-1))))
   `(proof-warning-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-yellow-1))))
;;;;; racket-mode
...
;;;;; re-builder
   `(reb-match-0 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-magenta))))
   `(reb-match-1 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-blue))))
   `(reb-match-2 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-orange))))
   `(reb-match-3 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-red))))
;;;;; realgud
...
;;;;; speedbar
   ...
   `(speedbar-highlight-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-green+2))))
   `(speedbar-selected-face ((t (:foreground ,zenburn-red))))
   `(speedbar-separator-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-blue-1))))
   `(speedbar-tag-face ((t (:foreground ,zenburn-yellow))))
;;;;; sx
   `(sx-custom-button
     ((t (:background ,zenburn-fg :foreground ,zenburn-bg-2
   ...
   `(sx-question-mode-kbd-tag
     ((t (:box (:color ,zenburn-bg-2 :line-width 3 :style released-button)
...
;;;;; tabbar
   ...
   `(tabbar-unselected ((t (:foreground ,zenburn-fg
                                        ...
                                        :box (:line-width -1 :style released-button)))))
;;;;; term
   `(term-color-black ((t (:foreground ,zenburn-bg-1
                                       :background ,zenburn-bg-2))))
...
;;;;; visual-regexp
   `(vr/group-0 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-green :weight bold))))
   `(vr/group-1 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-orange :weight bold))))
   `(vr/group-2 ((t (:foreground ,zenburn-bg-1 :background ,zenburn-blue :weight bold))))
   `(vr/match-0 ((t (:inherit isearch))))
   `(vr/match-1 ((t (:foreground ,zenburn-yellow-2 :background ,zenburn-bg-2 :weight bold))))
...
;;;;; web-mode
   ...
   `(web-mode-server-background-face ((t (:background ,zenburn-bg-1))))
...
;;;;; whitespace-mode
   ...
   `(whitespace-line ((t (:background ,zenburn-bg-1 :foreground ,zenburn-magenta))))
...
;;;;; xcscope
   ...
   `(cscope-mouse-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-blue+1))))
   `(cscope-separator-face ((t (:foreground ,zenburn-red :weight bold
                                            :underline t :overline t))))
;;;;; yascroll
   `(yascroll:thumb-text-area ((t (:background ,zenburn-bg-2))))
   `(yascroll:thumb-fringe ((t (:background ,zenburn-bg-2 :foreground ,zenburn-bg-2))))
   ))
...
(zenburn-with-color-variables
  (custom-theme-set-variables
   'zenburn
;;;;; ansi-color
   `(ansi-color-names-vector [,zenburn-bg-1 ,zenburn-red ,zenburn-green ,zenburn-yellow
...
;;;;; vc-annotate
   ...
   `(vc-annotate-background ,zenburn-bg-2)
   ))
