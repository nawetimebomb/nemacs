...
(use-package org
  :bind
  (("C-c a" . (lambda () (interactive) (org-agenda :keys "n")))
   ("C-c c" . org-capture)
   ("C-c t" . (lambda () (interactive) (org-capture :keys "t")))
   ("C-c m" . (lambda () (interactive) (org-capture :keys "m")))
...
(setq org-todo-keywords
      ...
      org-capture-templates '(("t" "Add a Todo"
                              ...
                              ("e" "Add Emacs-related note"
                               ...
                               "** %? :EMACS:" :kill-buffer t :empty-lines-before 1)
