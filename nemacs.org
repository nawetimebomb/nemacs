...
(use-package spaceline
  ...
  (progn
    ...
    (spaceline-define-segment nemacs-unread-emails
      "Show the number of unread emails from mu4e"
      (when mu4e-alert-mode-line
    ...
    (spaceline-install
      ...
      '((nemacs-flycheck-info :face powerline-active1)
        (nemacs-unread-emails :face powerline-active1)
