...
(defun rs-gnus-summary-tree-arrows-latin ()
  ...
  (interactive)
  (setq ;; Ã—
   gnus-sum-thread-tree-false-root      "Ã·Â» "
   gnus-sum-thread-tree-single-indent   "== "
   gnus-sum-thread-tree-root            "Ã—Â» "
   gnus-sum-thread-tree-vertical        "|"
   gnus-sum-thread-tree-leaf-with-other "+-> "
   gnus-sum-thread-tree-single-leaf    "\\-> " ;; "\\" is _one_ char
   gnus-sum-thread-tree-indent          " ")
...
(defun rs-gnus-summary-tree-arrows-wide ()
  ...
  (interactive)
  (setq
   gnus-sum-thread-tree-false-root      "â”ˆâ”¬â”€â”€â–· "
   gnus-sum-thread-tree-single-indent   " â—  "
   gnus-sum-thread-tree-root            "â”Œâ”€â–¶ "
   gnus-sum-thread-tree-vertical        "â”‚"
   gnus-sum-thread-tree-leaf-with-other "â”œâ”¬â”€â–º "
   gnus-sum-thread-tree-single-leaf     "â•°â”¬â”€â–º "
   gnus-sum-thread-tree-indent          " ")
...
(defun rs-gnus-summary-tree-arrows-test ()
  ...
  (setq
   ...
   gnus-sum-thread-tree-single-indent   "â—  " ;; " â–· "
   gnus-sum-thread-tree-root            "â”Œâ–¶ "
   gnus-sum-thread-tree-vertical        "â”‚"
...
(defun rs-gnus-summary-tree-arrows-01 ()
  ...
  (interactive)
  (setq
   gnus-sum-thread-tree-false-root      "â”Œâ–· "
   gnus-sum-thread-tree-single-indent   " â–· "
   gnus-sum-thread-tree-root            "â”Œâ”¬â–¶ "
   gnus-sum-thread-tree-vertical        "â”‚"
   gnus-sum-thread-tree-leaf-with-other "â”œâ”¬â–º "
...
(defun rs-gnus-summary-tree-lines-rs ()
  ...
  (interactive)
  (setq
   ;; gnus-summary-line-format "%Â«%U%R%z%u&ct; %4k: %B%Â»%(%-20,20f%) %s\n"
   ;; gnus-sum-thread-tree-false-root      "  "
   gnus-sum-thread-tree-single-indent   " "
   gnus-sum-thread-tree-root            "â”Œ"
   gnus-sum-thread-tree-vertical        "â”‚"
   gnus-sum-thread-tree-leaf-with-other "â”œâ•® "
...
(defun rs-gnus-summary-line-initialize ()
  ...
  (setq gnus-summary-line-format
	"%Â«%U%R%u&score;%u&ct; %4u&size;%Â»%* %(%-20,20f%) %1Â«%1{%B %}%s%Â»\n"))
