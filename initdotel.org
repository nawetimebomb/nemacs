...
(setq elnawe/forecast-icons-colors '(("clear-day" "\xf185 " :foreground "#F0DFAF")
                                     ("clear-night" "" :foreground "")
                                     ("cloudy" "" :foreground "")
                                     ("fog" "" :foreground "")
                                     ("partly-cloudy-day" "\xf0c2 " :foreground "#6F6F6F")
    ...
    (propertize
     (concat
      (with-face
       ...
       (cdr (elnawe::forecast/get-metadata)))
...
(use-package ido
  ...
  (setq-default
   ...
   ido-ignore-buffers '("\\ " "*scratch*" "*Ibuffer*" "*Completions*" "*Backtrace*" "spotify-player-status")
...
(eval-and-compile
  ...
  (setq-default spotify-api-search-limit 25
                spotify-mode-line-format "%at - %tt"
